	...
	<section>
		<div id="board_box">
			...
			<ul class="buttons">
				...
				<li><button onclick="location.href='board_modify_form.php?num=<?= $num ?>&page=<?= $page ?>&mode=modify'">수정</button></li>
				<!-- <li><button onclick="location.href='board_dml.php?num=<?= $num ?>&page=<?= $page ?>&mode=delete'">삭제</button></li> -->
				<li>
					<form method="post" action="board_dml.php" enctype="multipart/form-data">
